...
same workflow can be applied to similar experiment datasets without leaving
analysis steps hardcoded inside a notebook.
...
All functions include comments and docstrings in English explaining
their purpose, inputs, outputs, and intended reuse.
"""
